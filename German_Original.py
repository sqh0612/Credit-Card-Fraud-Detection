...
X_train_german, X_test_german, y_train_german, y_test_german = train_test_split(df1.iloc[:, 0:-1], df1.iloc[:, -1],
...
print("German-Credit-Data : No. of positive samples = {}, No. of negative samples = {}".format(
