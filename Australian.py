...
# 数据准备
print()
print("Australian-Credit-Data View")
print("--------------------------------------------------------------")
df_australian = pd.read_csv("Data/australian.csv", header=None)
print("Australian-Credit-Data : No. of positive samples = {}, No. of negative samples = {}".format(
    df_australian.loc[df_australian.iloc[:, -1] == 1, :].shape[0],
    df_australian.loc[df_australian.iloc[:, -1] == 0, :].shape[0]))
print("--------------------------------------------------------------")
print()
X_train_australian, X_test_australian, y_train_australian, y_test_australian = train_test_split(
    df_australian.iloc[:, 0:-1], df_australian.iloc[:, -1], test_size=0.30, random_state=0)
print()
    ...
    if algorithm == 'bay':
        for training_size in training_sizes:
            ...
            if training_size == 1.0:
                ...
                test_error, temp_time2 = bay(X_train_temp, y_train_temp, X_test_australian, y_test_australian, recall_score, 5,
                                             0, 15, 1, 0)
        ...
        plt.savefig("Australian-Credit-Data-NB.png")
        plt.close()
        ...
        for training_size in training_sizes:
            ...
            if training_size == 1.0:
                train_error, temp_time1 = KNN(X_train_temp, y_train_temp, X_train_temp, y_train_temp, accuracy_score, 5,
                                              0, 14, 0, 0)
                error_rate_training_data.append(train_error)
                test_error, temp_time2 = KNN(X_train_temp, y_train_temp, X_test_australian, y_test_australian,
                                             accuracy_score, 5, 0, 14, 1, 0)
                error_rate_testing_data.append(test_error)
                time_taken_temp.append(temp_time1)
            else:
                train_error, temp_time1 = KNN(X_train_temp, y_train_temp, X_train_temp, y_train_temp, accuracy_score, 5,
        ...
        plt.ylabel("AUC score")
        plt.title("KNN")
        plt.savefig("Australian-Credit-Data-KNN.png")
        plt.close()
        ...
        for training_size in training_sizes:
            ...
            if training_size == 1.0:
                train_error, temp_time1 = dt(X_train_temp, y_train_temp, X_train_temp, y_train_temp, accuracy_score, 5,
                                             0, 14, 0, 0)
                error_rate_training_data.append(train_error)
                test_error, temp_time2 = dt(X_train_temp, y_train_temp, X_test_australian, y_test_australian,
                                            accuracy_score, 5, 0, 14, 1, 0)
                error_rate_testing_data.append(test_error)
                time_taken_temp.append(temp_time1)
            else:
        ...
        plt.savefig("Australian-Credit-Data-DT.png")
        plt.close()
        ...
        for training_size in training_sizes:
            ...
            if training_size == 1.0:
                train_error, temp_time1 = svc(X_train_temp, y_train_temp, X_train_temp, y_train_temp, accuracy_score, 5,
                                              0, ['linear'], 14, 0, 0)
                error_rate_training_data.append(train_error)
                test_error, temp_time2 = svc(X_train_temp, y_train_temp, X_test_australian, y_test_australian,
                                             accuracy_score, 5, 0, ['linear'], 14, 1, 0)
                error_rate_testing_data.append(test_error)
                time_taken_temp.append(temp_time1)
            else:
                train_error, temp_time1 = svc(X_train_temp, y_train_temp, X_train_temp, y_train_temp, accuracy_score, 5,
                ...
                error_rate_training_data.append(train_error)
                test_error, temp_time2 = svc(X_train_temp, y_train_temp, X_test_australian, y_test_australian,
                                             accuracy_score, 5, 0, ['linear'], 14, 0, 0)
                error_rate_testing_data.append(test_error)
                time_taken_temp.append(temp_time1)
        ...
        plt.ylabel("AUC score")
        plt.title("SVM")
        plt.savefig("Australian-Credit-Data-SVM.png")
        plt.close()
        ...
        for training_size in training_sizes:
            ...
            if training_size == 1.0:
                train_error, temp_time1 = nn(X_train_temp, y_train_temp, X_train_temp, y_train_temp, accuracy_score, 5,
                                             0, 14, 0, 0)
                error_rate_training_data.append(train_error)
                test_error, temp_time2 = nn(X_train_temp, y_train_temp, X_test_australian, y_test_australian,
                                            accuracy_score, 5, 0, 14, 1, 0)
                error_rate_testing_data.append(test_error)
                time_taken_temp.append(temp_time1)
            else:
        ...
        plt.savefig("Australian-Credit-Data-NN.png")
        plt.close()
...
plt.legend()
plt.title("Training Time for Australian Credit Data")
plt.savefig("Australian-Credit-Data-Time.png")
plt.close()
